    ...
    <SafeAreaView style={{flex: 1}}>
      ...
      <View style={{flex: 1, padding: SPACING, flexDirection: 'row'}}>
        ...
        <View style={{flex: 0.65, overflow: 'hidden'}}>
          <Animatable.Image
            source={{
              uri: 'https://img.rawpixel.com/s3fs-private/rawpixel_images/website_content/v835-katie-20.jpg?w=1300&dpr=1&fit=default&crop=default&q=80&vib=3&con=3&usm=15&bg=F4F4F3&ixlib=js-2.2.1&s=21f0ddd9769e75e28dc3760a4fb3fbc4',
            }}
            useNativeDriver
            animation={animation}
            delay={700}
